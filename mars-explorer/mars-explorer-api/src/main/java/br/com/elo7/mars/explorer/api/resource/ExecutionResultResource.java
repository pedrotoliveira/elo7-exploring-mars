...
public class ExecutionResultResource {
	...
	@ApiModelProperty(required = true, value = "The Start Position")
	@NotNull
	private Position startPosition;

	@JsonProperty("finalPosition")
	@ApiModelProperty(required = true, value = "The final position")
	@NotNull
	private Position finalPosition;

	@JsonProperty("instruction")
	@ApiModelProperty(required = true, value = "The instruction")
	@NotNull
	...
	public ExecutionResultResource startPosition(Position startPosition) {
		this.startPosition = startPosition;
		return this;
	}

	public ExecutionResultResource finalPosition(Position finalPosition) {
		this.finalPosition = finalPosition;
		return this;
	}
